...
void swiftnet_resize_packet_buffer(uint32_t new_buffer_size, struct SwiftNetPacketBuffer* restrict const packet_buffer) {
    void* new_ptr;
    void* data_start; 
...
void swiftnet_destroy_packet_buffer(const struct SwiftNetPacketBuffer* restrict const packet) {
